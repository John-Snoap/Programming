...
public class LRP
{
	...
	public void setPairList(ForwardingTable myForwardingTable, int destinyLL3PAddress)
	{
		...
		sequenceNumber = (sequenceNumber + totalNumberOfSequenceNumbers) % (NetworkConstants.NUMBER_OF_NET_DIST_PAIRS_PER_PKT + 2);
		...
		//sequenceNumber = (sequenceNumber + totalNumberOfSequenceNumbers) % (NetworkConstants.NUMBER_OF_NET_DIST_PAIRS_PER_PKT);
	...
	{
		byte[][] value = new byte[totalNumberOfSequenceNumbers][];
		...
		for (int sequenceNum = 0; sequenceNum < totalNumberOfSequenceNumbers; sequenceNum++)
		{
			...
			int valueForSeqNum = (mySequenceNumber - totalNumberOfSequenceNumbers + sequenceNum) % (NetworkConstants.NUMBER_OF_NET_DIST_PAIRS_PER_PKT + 2);
			...
			valueString.append(Integer.toHexString(valueForSeqNum));
			//valueString.append(Integer.toHexString((mySequenceNumber - totalNumberOfSequenceNumbers + sequenceNum) % (NetworkConstants.NUMBER_OF_NET_DIST_PAIRS_PER_PKT)));
	...
	// private methods
	private void initializePairLists()
	{
		pairList = new ArrayList<NetworkDistancePair>();
		this.splitUpPairList = new ArrayList<List<NetworkDistancePair>>();
	} // end private method initializePairLists
