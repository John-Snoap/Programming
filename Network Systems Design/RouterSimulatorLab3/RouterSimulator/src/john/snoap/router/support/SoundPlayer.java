...
/**
 * This class is responsible for playing sounds for the user. It is a part of
 * the user interface. any class that needs to make sounds will use this class
 * to play them.
 * 
 * @author pat.smith
 * 
...
public class SoundPlayer
{
	...
	public void playSound(int soundID)
	{
		switch (soundID)
		{
		case NetworkConstants.badPacketSound : playBadPacketSound();
			break;
		case NetworkConstants.packetSentSound : playPacketSentSound();
			break;
		case NetworkConstants.buttonPressSound : playButtonPressSound();
			break;
		case NetworkConstants.receiveMessageSound : playReceiveMessageSound();
			break;
		case NetworkConstants.sendMessageSound : playSendMessageSound();
			break;
		case NetworkConstants.alertSound : playAlertSound();
			break;
		}
	}
	...
	public void playAlertSound()
	{
		...
		if (soundsLoaded)
		{
			notificationSounds.play(alertSoundID, currentVolume, currentVolume, soundPriority, dontLoopSound, normalPlaybackRate);
		}
	}
	...
	public void playBadPacketSound()
	{
		...
		if (soundsLoaded)
		{
			notificationSounds.play(badPacketSoundID, currentVolume, currentVolume, soundPriority, dontLoopSound, normalPlaybackRate);
		}
	}
	...
	public void playPacketSentSound()
	{
		...
		if (soundsLoaded)
		{
			notificationSounds.play(packetSentSoundID, currentVolume, currentVolume, soundPriority, dontLoopSound, normalPlaybackRate);
		}
	}
	...
	public void playButtonPressSound()
	{
		...
		if (soundsLoaded)
		{
			notificationSounds.play(buttonPressSoundID, currentVolume, currentVolume, soundPriority, dontLoopSound, normalPlaybackRate);
		}
	}
	...
	public void playReceiveMessageSound()
	{
		...
		if (soundsLoaded)
		{
			notificationSounds.play(this.receiveMessageSoundID, currentVolume, currentVolume, soundPriority, dontLoopSound, normalPlaybackRate);
		}
	}
	...
	public void playSendMessageSound()
	{
		...
		if (soundsLoaded)
		{
			notificationSounds.play(this.sendMessageSoundID, currentVolume, currentVolume, soundPriority, dontLoopSound, normalPlaybackRate);
		}
	}

	public void updateObjectReferences(Factory factory)
	{
		// does nothing... currently needs no external objects because I'm just
		// a lowly servant.
