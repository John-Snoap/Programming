...
public class LL2P
{
	...
	public void setDestinationLL2P_MACaddress(int value)
	{
		try
		{
			...
			{
				Log.i("LL2P", "Dest MAC Addr int is wrong!");
		...
		{
			Log.i("LL2P", "There was an error converting from an int to a hex string\nwhile setting the destination MAC Address (int).\n\n");
	...
	public void setDestinationLL2P_MACaddress(String value)
	{
		try
		{
			...
			{
				Log.i("LL2P", "Dest MAC Addr string greater than 6 characters!");
				destinationLL2P_MACaddressString = "000000";
			} // end if
			else
			{
		...
		{
			Log.i("LL2P", "There was an error converting from a hex string to an int\nwhile setting the destination MAC Address (String).\n\n");
			destinationLL2P_MACaddressString = "000000";
			destinationLL2P_MACaddress = 0;
		} // end catch
	...
	public void setSourceLL2P_MACaddress(int value)
	{
		try
		{
			if (value > 0xFFFFFF || value < 0)
			{
				Log.i("LL2P", "Source MAC Addr int is wrong!");
	...
	public void setSourceLL2P_MACaddress(String value)
	{
		try
		{
			if (value.length() > (2 * NetworkConstants.LL2P_ADDRESS_LENGTH))
			{
				Log.i("LL2P", "Source MAC Addr string greater than 6 characters!");
				sourceLL2P_MACaddressString = "000000";
			} // end if
			else
			{
	...
	public void setTypeField(int value)
	{
		try
		{
			...
			{
				Log.i("LL2P", "Type Field int is wrong!");
	...
	public void setTypeField(String value)
	{
		try
		{
			...
			{
				Log.i("LL2P", "Type Field string greater than 4 characters!");
				typeFieldString = "0000";
			} // end if
			else
			{
	...
	public LL2P(byte[] inCommingBytes)
	{
		try
		{
			...
			if (!(crc.getCRCHexString().equalsIgnoreCase(inCommingCRC)))
			{
				...
				Log.i("LL2P", "CRC did not match, therefore there are errors in the in-comming bits!");
				// for now I will ignore a mismatched crc
				//zeroEverything();
				//crc.resetCRC();
		...
		{
			uiMangaer.raiseToast("In-comming bytes are wrong!");
			Log.i("LL2P", "In-comming bytes are wrong!");
			zeroEverything();
		} // end catch
