...
{
    class TieBomber : EnemyFighter
    {
        // private data
        private const int MOVE_SPEED = 5;
        private const int HIT_POINTS = 4;
        ...
        // constructor
        public TieBomber(Vector2 pos) : base(pos, HIT_POINTS)
        {
        } // end constructor
        ...
        {
            return new TieBomb(new Vector2((GunPosition.X - TieBomb.Texture.Width / 2), GunPosition.Y));
