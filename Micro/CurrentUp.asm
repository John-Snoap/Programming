...
quadrantLength			EQU		63								;The horizontal length allocated for each quadrant
...
* ;Main														COMMENTS
				...
				LDX		#$1039								;Load X for A/D converter
				BSET		0,X			%10000000				;Initialize internal A/D converter
				...
				LDAA		#$20								;Trust Watson for delay knob
				STAA		$1030								;Trust Watson Result will be in loc $1031
