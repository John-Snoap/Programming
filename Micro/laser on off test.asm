...
* ;Main														COMMENTS
				...
				LDAA		#$B0								;Load (00000000)
				LDAB		#$D0								;Load (11111111)
laserOnOff			STAA		bright								;Send x-coordinate -> PIA
				JSR		delay4ms							;Delay for 4 milliseconds
				STAB		dim								;Send y-coordinate -> PIA
				JSR		delay4ms							;Delay for 4 milliseconds
				BRA		laserOnOff							;Go to laserOnOff
* ;Main end
...
* ;Subrutine delay4ms												COMMENTS
delay4ms			PSHA										;Saves A
				LDAA		#100								;80 * 50us = 4ms
